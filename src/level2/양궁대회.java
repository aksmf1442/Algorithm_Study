...
/**
 * goal:
 * 1. 라이언이 어피치를 가장 큰 점수차로 이기기 위해서 n발의 화살을 어떤 과녁 점수에 맞혀야 하는지 구하기
 * 2. 어피치가 이미 쏜 상태이고 라이언이 어피치를 가장 큰 점수차로 이기기 위한 방법을 찾아야 한다.
 */

/**
 * 알아야 할 것
 * 1. 0~10사이의 과녁에 어피치와 라이언이 같은 곳에 같은 수의 화살이 박혔을 경우는 어피치가 우선순위를 갖는다.
